...
export async function middleware(request: NextRequest) {
  ...
  const isPrivate = ["/dashboard", "/programs", "/progress", "/achievements", "/exercises", "/guide", "/build", "/generate", "/circuit", "/ballet", "/workouts", "/warmups", "/my-workouts", "/menu", "/onboarding", "/training-styles", "/start-here", "/settings", "/welcome", "/admin", "/plan", "/load", "/training-science", "/anatomy"].some((p) =>
    path.startsWith(p)
  );
